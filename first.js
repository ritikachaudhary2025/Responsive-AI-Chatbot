...
//API setup
const API_KEY = "AQ.Ab8RN6KEb506CBJvZND49gBw_ukkTxgYFpU6gd1lAiea23-xfw";
...
fileInput.addEventListener("change", () => {
    ...
    reader.onload = (e) => {
        ...
        const base64Data = e.target.result.split(",")[1]; // Get base64 data without the prefix
      
        //Stores file data in the userData
        userData.file= {
        data: base64Data,
        mime_type: file.type
    }
    ...
    //Initialize emoji picker and handel emoji selection
